...
extern const MIDL_SERVER_INFO RpcServiceSample_ServerInfo;

extern const RPC_DISPATCH_TABLE RpcServiceSample_v1_0_DispatchTable;
...
/* 596 */	0x0,		/* 0 */
			0x6a,		/* Old Flags:  DCE mem package, comm or fault/decode */
/* 598 */	NdrFcLong( 0x0 ),	/* 0 */
...
static void  __RPC_USER
RpcServiceSample_free_wrapper( void * _p )
{
    free( _p );
}
...
static const MIDL_STUB_DESC RpcServiceSample_StubDesc = 
    {
    (void *)& RpcServiceSample___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION RpcServiceSample_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE RpcServiceSample_v1_0_DispatchTable = 
    {
    17,
    (RPC_DISPATCH_FUNCTION*)RpcServiceSample_table
    };

static const SERVER_ROUTINE RpcServiceSample_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Ping,
    (SERVER_ROUTINE)CheckSecurity,
    (SERVER_ROUTINE)BufferIn1,
    (SERVER_ROUTINE)BufferIn2,
    (SERVER_ROUTINE)BufferIn3,
    (SERVER_ROUTINE)BufferOut1,
    (SERVER_ROUTINE)BufferOut2,
    (SERVER_ROUTINE)BufferOut3,
    (SERVER_ROUTINE)BufferOut4,
    (SERVER_ROUTINE)StructsIn1,
    (SERVER_ROUTINE)StructsIn2,
    (SERVER_ROUTINE)StructsIn3,
    (SERVER_ROUTINE)ListIn,
    (SERVER_ROUTINE)ListOut1,
    (SERVER_ROUTINE)ListOut2,
    (SERVER_ROUTINE)UnionCall1,
    (SERVER_ROUTINE)UnionCall2
    };

static const MIDL_SERVER_INFO RpcServiceSample_ServerInfo = 
    {
    &RpcServiceSample_StubDesc,
    RpcServiceSample_ServerRoutineTable,
    RpcInterface__MIDL_ProcFormatString.Format,
    RpcServiceSample_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
